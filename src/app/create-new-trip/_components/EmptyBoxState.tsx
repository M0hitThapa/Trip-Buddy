...
function EmptyBoxState({ onPromptClick }: EmptyBoxStateProps) {
  return (
    <div>
      <div className="flex flex-col justify-center items-center">
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <g>
                ...
                <g>
                  ...
                  <path
                    fill="#EFDAB6"
                    d="M79.121,87.06c-1.456,0.562-2.624,1.101-2.624,1.101l4.69,3.566l0.196,2.764h0.219l-0.415-5.861 L79.121,87.06z"
                  ></path>{" "}
                  <path
                    fill="#EFDAB6"
                    d="M23.878,92.941c-0.037,0.512-0.094,1.032-0.18,1.55h0.233C23.929,93.944,23.91,93.422,23.878,92.941z"
                  ></path>{" "}
                  <polygon
                    fill="#EFDAB6"
                    points="20.045,48.908 15.908,51.733 15.908,54.83 21.38,51.093 "
                  ></polygon>{" "}
                  <rect
                    x="15.908"
                    y="26.311"
                ...
                <g>
                  ...
                  <g>
                    ...
                    <path
                      fill="#136296"
                      d="M15.908,26.817C9.893,26.817,5,21.924,5,15.91S9.893,5.003,15.908,5.003 c6.014,0,10.907,4.893,10.907,10.907S21.922,26.817,15.908,26.817z M15.908,6.015c-5.457,0-9.897,4.439-9.897,9.896 s4.439,9.896,9.897,9.896c5.457,0,9.896-4.439,9.896-9.896S21.364,6.015,15.908,6.015z"
                    ></path>{" "}
                  </g>{" "}
                  <g>
                    {" "}
                  ...
                  <g>
                    ...
                    <g>
                      ...
                      <path
                        fill="#136296"
                        d="M15.917,26.817c-0.279,0-0.508-0.226-0.508-0.506s0.224-0.506,0.503-0.506h0.005 c0.279,0,0.506,0.226,0.506,0.506S16.197,26.817,15.917,26.817z"
                      ></path>{" "}
                    </g>{" "}
                    <g>
                      {" "}
                    ...
                    <g>
                      ...
                      <path
                        fill="#136296"
                        d="M15.917,6.015c-0.279,0-0.508-0.226-0.508-0.506c0-0.279,0.224-0.506,0.503-0.506h0.005 c0.279,0,0.506,0.226,0.506,0.506C16.423,5.788,16.197,6.015,15.917,6.015z"
                      ></path>{" "}
                    </g>{" "}
                  </g>{" "}
                </g>{" "}
                ...
                <g>
                  ...
                  <g>
                    ...
                    <path
                      fill="#136296"
                      d="M24.972,71.992c-0.022,0-0.045-0.001-0.067-0.005c-0.277-0.037-0.471-0.289-0.435-0.565 c0.004-0.031,0.104-0.767,0.584-1.822c0.116-0.254,0.414-0.367,0.67-0.251c0.254,0.116,0.366,0.415,0.251,0.669 c-0.412,0.906-0.501,1.53-0.502,1.536C25.439,71.807,25.221,71.992,24.972,71.992z"
                    ></path>{" "}
                  </g>{" "}
                  <g>
                    {" "}
                  ...
                  <g>
                    ...
                    <path
                      fill="#136296"
                      d="M74.916,38.734c-0.268,0-0.491-0.211-0.505-0.481c-0.027-0.562-0.074-1.145-0.139-1.735 c-0.031-0.277,0.17-0.527,0.447-0.558c0.279-0.032,0.527,0.17,0.558,0.447c0.067,0.61,0.116,1.214,0.144,1.796 c0.013,0.279-0.202,0.516-0.48,0.53C74.933,38.734,74.924,38.734,74.916,38.734z"
                    ></path>{" "}
                  </g>{" "}
                </g>{" "}
                <path
                  fill="#F0566F"
                  d="M75.206,33.474l1.072-1.073c0.198-0.197,0.198-0.518,0-0.715c-0.198-0.197-0.517-0.197-0.715,0 l-1.072,1.073l-1.072-1.073c-0.198-0.197-0.517-0.197-0.715,0c-0.198,0.197-0.198,0.517,0,0.715l1.072,1.073l-1.072,1.073 c-0.198,0.197-0.198,0.518,0,0.715c0.099,0.099,0.228,0.148,0.357,0.148c0.129,0,0.259-0.049,0.357-0.148l1.072-1.073l1.072,1.073 c0.099,0.099,0.228,0.148,0.357,0.148s0.259-0.049,0.357-0.148c0.198-0.197,0.198-0.517,0-0.715L75.206,33.474z"
                ></path>{" "}
                <g>
                  {" "}
                  <path
                    fill="#136296"
                    d="M24.127,80.87c-1.905,0-3.455-1.55-3.455-3.455c0-1.905,1.55-3.455,3.455-3.455 c1.905,0,3.455,1.55,3.455,3.455C27.581,79.32,26.032,80.87,24.127,80.87z M24.127,74.972c-1.347,0-2.444,1.096-2.444,2.443 s1.096,2.444,2.444,2.444c1.347,0,2.444-1.096,2.444-2.444S25.474,74.972,24.127,74.972z"
                  ></path>{" "}
                </g>{" "}
                <g>
                  {" "}
                ...
                <g>
                  ...
                  <path
                    fill="#136296"
                    d="M71.117,72.673c-0.024,0-0.047-0.001-0.072-0.005c-0.275-0.039-0.466-0.29-0.43-0.565 c0.105-0.787,0.902-2.274,3.069-2.204c0.279,0.007,0.5,0.239,0.493,0.518c-0.007,0.279-0.252,0.509-0.518,0.492 c-0.033-0.001-0.064-0.001-0.095-0.001c-1.692,0-1.925,1.195-1.946,1.333C71.58,72.492,71.364,72.673,71.117,72.673z"
                  ></path>{" "}
                </g>{" "}
                <g>
                  {" "}
                  <path
                    fill="#136296"
                    d="M55.433,83.529c-0.024,0-0.047-0.001-0.072-0.005c-0.275-0.039-0.466-0.29-0.43-0.565 c0.105-0.787,0.899-2.269,3.069-2.204c0.279,0.007,0.5,0.239,0.493,0.518c-0.007,0.279-0.231,0.505-0.518,0.492 c-0.033-0.001-0.064-0.001-0.095-0.001c-1.692,0-1.925,1.195-1.946,1.333C55.896,83.347,55.68,83.529,55.433,83.529z"
                  ></path>{" "}
                </g>{" "}
              </g>{" "}
            </g>
          </svg>
          <h1 className=" text-neutral-900 text-2xl font-semibold  mt-5">
            Hi I&apos;m{" "}
            <span className="text-teal-600 bg-white text-shadow-md font-bold text-3xl px-2 py-1 rounded-lg border-2 shadow-input">
              Sophia
            </span>
        ...
        <div>{/* Reserved for a short Sophia blurb if needed */}</div>
      </div>
    </div>
  );
}
